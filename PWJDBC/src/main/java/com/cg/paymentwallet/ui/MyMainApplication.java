	...
	{  	
		...
		do{
			...
			case 2:
									...
									case 1:
										...
										try {
											...
											if(error)
											{
												...
												Wallet wall5 = paymentwalletservice.withdrawMoney(number, balance1);
												/* System.out.println(wall5.getEmailId());
			       	 System.out.println(wall5.getGender());
			       	 System.out.println(wall5.getName());*/
												System.out.println("Balance available is:"+wall5.getBalance());
											}
											//}
				...
				{*/
											...
											if(error)
											{
												...
												Wallet wall3 = paymentwalletservice.depositMoney(number, balance2);
												System.out.println("Balance available is:"+wall3.getBalance());
											}
											//	}
										} catch (PaymentWalletException e) {
											// TODO Auto-generated catch block
				...
				{*/
											...
											if(error)
											{
												...
												if(error)
												{
													Wallet wall4 = paymentwalletservice.fundTransfer(number, phone4, balance3);
													/*  System.out.println(wall4.getEmailId());
			       System.out.println(wall4.getGender());
			       System.out.println(wall4.getName());*/
													System.out.println("Balance available is:"+wall4.getBalance());
												}
											}
											//}
										} catch (PaymentWalletException e) {
			...
			{*/
											...
											Wallet wall1 = paymentwalletservice.showBalance(number);
											/* System.out.println(wall1.getEmailId());
			       System.out.println(wall1.getGender());
			       System.out.println(wall1.getName());*/
											System.out.println("Balance available is:"+wall1.getBalance());
											//}
										} catch (PaymentWalletException e) {
											// TODO Auto-generated catch block
											System.out.println(e.getMessage());
			...
			{*/
											...
											Scanner sc2=new Scanner(result).useDelimiter("zzz");
											while(sc2.hasNext())
											{
